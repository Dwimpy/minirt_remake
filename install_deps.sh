...
# Just a simple script, that installs all dependencies for the project
# I could check if the dependencies are already installed, but I'm lazy
# so I simply check if the dependencies are already built within the project
