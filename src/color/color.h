...
t_color		color_division(t_color a, t_color b) __attribute__((unused));
t_color		color_division_s(t_color a, t_real s) __attribute__((unused));
t_color		color_add(t_color a, t_color b);
t_color		color_subtract(t_color a, t_color b) __attribute__((unused));
